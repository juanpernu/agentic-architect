...
-- 2b. Safety net: fill any orphaned rows
UPDATE incomes SET category = 'Sin categoría' WHERE category IS NULL;
UPDATE expenses SET category = 'Sin categoría' WHERE category IS NULL;
...
-- 5. Drop seed trigger
DROP TRIGGER IF EXISTS trg_seed_income_types ON organizations;
